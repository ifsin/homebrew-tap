class Gameboy < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/ifsin/homebrew-tap/releases/download/res/gameboy-darwin-arm64"
      sha256 "1c3cce680dd47a6b2f43ef46a1fdf930ceadb4ea89737f0de9cb8e90288ef267"
    end
    on_intel do
      url "https://github.com/ifsin/homebrew-tap/releases/download/res/gameboy-darwin-amd64"
