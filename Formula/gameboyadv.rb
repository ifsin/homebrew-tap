class Gameboyadv < Formula
  ...
  on_macos do
    on_arm do
      url "https://raw.githubusercontent.com/ifsin/homebrew-tap/main/releases/gameboyadv/0.1.0/gameboyadv-darwin-arm64"
      sha256 "f34dc8d8d39cf554c6b42f13f36ec855ecb42854d592065f06a55b738713ff36"
    end
    on_intel do
      url "https://raw.githubusercontent.com/ifsin/homebrew-tap/main/releases/gameboyadv/0.1.0/gameboyadv-darwin-amd64"
